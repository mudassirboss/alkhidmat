...
<div class="container-fluid">
    ...
    <div class="header-bar mb-4 d-flex justify-content-between align-items-center">
        <h1 class="h3 mb-0 text-gray-800" style="font-family: 'Outfit', sans-serif; font-weight: 700;">Edit Story</h1>
                ...
                <div class="card shadow-sm mb-4 border-0" style="border-radius: 12px;">
                    ...
                    <div class="card-body">
                        <div class="form-group mb-4">
                            ...
                            <input type="text" name="title" class="form-control" value="{{ $post->title }}" placeholder="Enter story title..." required style="height: 45px; font-weight: 500;">
                        </div>

                        <div class="form-group mb-0">
                            <label class="form-label font-weight-bold text-muted small text-uppercase">Content</label>
                            <textarea name="content" class="rich-editor" rows="10" placeholder="Write your story here...">{{ $post->content }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card shadow-sm mb-4 border-0" style="border-radius: 12px;">
                    ...
                    <div class="card-body text-center">
                        <div class="mb-3 position-relative d-inline-block w-100">
                             @if($post->image)
                                <div class="bg-light rounded mx-auto d-flex align-items-center justify-content-center mb-3 text-muted profile-preview" style="width: 100%; height: 200px; border: 2px solid #ddd; background-image: url('{{ asset('images/' . $post->image) }}'); background-size: cover; background-position: center;">
                                </div>
                            @else
                                <div class="bg-light rounded mx-auto d-flex align-items-center justify-content-center mb-3 text-muted profile-preview" style="width: 100%; height: 200px; border: 2px dashed #dee2e6;">
